...
//		
	...
	private static final String[] JPF_ARGS = 
			new String[] {"+shell.port=4242", "+site=settings/site.properties", "settings/tsafe_greentrie.jpf"};
	...
	private static class Experiment {
		...
		private Experiment(String propertyClass, int propertyNumber) {
			...
			this.target = "test.driver.IntergrationTest" ;
			this.symbolicMethod=this.target+"."+"Intergration"+"(sym#sym)";
		}
