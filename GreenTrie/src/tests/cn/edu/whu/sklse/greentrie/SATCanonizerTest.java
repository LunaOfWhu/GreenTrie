...
public class SATCanonizerTest {
	...
	public static void initialize() {
		...
		props.setProperty("green.service.sat.slice", "cn.edu.whu.sklse.greentrie.slice.SATSlicerService");
		props.setProperty("green.service.sat.canonize", "cn.edu.whu.sklse.greentrie.canolize.SATCanonizerService");
	...
	public void test22() {
		...
		Operation o2 = new Operation(Operation.Operator.MUL, o1, c1);
		Operation o3 = new Operation(Operation.Operator.LT, o2, v1);
		check(o3, "((aa-bb)*2.0)<aa", "1.0*v+-2.0*v<0.0");
	}
	...
	public void test23() {
		...
		Operation o2 = new Operation(Operation.Operator.MUL, c1, o1);
		Operation o3 = new Operation(Operation.Operator.LT, o2, v1);
		check(o3, "(2.0*(aa-bb))<aa", "1.0*v+-2.0*v<0.0");
	}
	...
	public void test24() {
		RealVariable v1 = new RealVariable("aa", 0.0, 99.9);
		RealVariable v2 = new RealVariable("bb", 0.0, 99.9);
		RealVariable v3 = new RealVariable("cc", 0.0, 99.9);
		RealVariable v4 = new RealVariable("dd", 0.0, 99.9);
		RealVariable v5 = new RealVariable("ee", 0.0, 99.9);
		RealVariable v6 = new RealVariable("ff", 0.0, 99.9);
		RealVariable v7 = new RealVariable("gg", 0.0, 99.9);
		Operation o1 = new Operation(Operation.Operator.LT, v1, new Operation(Operation.Operator.ADD, v2, v3));
		Operation o2 = new Operation(Operation.Operator.LT, v2, new Operation(Operation.Operator.ADD, v4, v5));
		Operation o3 = new Operation(Operation.Operator.LT, v3, new Operation(Operation.Operator.ADD, v6, v7));
		Operation o23 = new Operation(Operation.Operator.AND, o2, o3);
		check(o1, o23, "(aa<(bb+cc))&&((bb<(dd+ee))&&(cc<(ff+gg)))", "1.0*v+-1.0*v+-1.0*v<0.0", "1.0*v+-1.0*v+-1.0*v<0.0",
				"1.0*v+-1.0*v+-1.0*v<0.0");
	}
	...
	public void test25() {
		...
		Operation o2 = new Operation(Operation.Operator.LT, v2, new Operation(Operation.Operator.ADD, v4, v5));
		Operation o3 = new Operation(Operation.Operator.LT, v3, new Operation(Operation.Operator.ADD, v6, v7));
		Operation o4 = new Operation(Operation.Operator.LT, new Operation(Operation.Operator.ADD, v6, v7),
				new Operation(Operation.Operator.ADD, v6, v7));
		Operation o23 = new Operation(Operation.Operator.AND, o2, o3);
		Operation o234 = new Operation(Operation.Operator.AND, o23, o4);
		
		check(o4, "(ff+gg)<(ff+gg)", "0==1");
	}
	...
	public void test28() {
		...
		Operation o3 = new Operation(Operation.Operator.MUL, c1, o2);
		Operation o4 = new Operation(Operation.Operator.LT, o3, v1);
		check(o4, "(2.0*((aa-bb)-0.0))<aa", "1.0*v+-2.0*v<0.0");
	}
	...
	public void test29() {
		...
		Operation o4 = new Operation(Operation.Operator.LT, o3, v1);
		check(o4, "(((aa-bb)/2.0)/1.0)<aa", "-0.5*v+-0.5*v<0.0");
	}
